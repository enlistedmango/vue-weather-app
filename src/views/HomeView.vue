    ...
    <main class="container text-white">
        <div class="pt-4 mb-8 relative">
            ...
            <ul class="absolute bg-weather-secondary text-white w-full shadow-md py-2 px-1 top-[66px]" v-if="mapboxSearchResults">
                ...
                <p class="py-2" v-if="!serverError && mapboxSearchResults.length === 0">No results match your query, try a different term.</p>
                <template v-else>
...
const mapboxAPIKey = "pk.eyJ1Ijoibm90bWFuZ28iLCJhIjoiY2xoNHo0Zm5sMDEwcTNmbXhraW16emoyZyJ9.U1SLR2BPTr6ltMDGU9hzmQ";
